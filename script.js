document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      "Experience lightning-fast 5G connectivity with Vodacom Tanzania. Play games, watch TV, and enjoy unlimited entertainment at affordable prices.":
        "Experience lightning-fast 5G connectivity with Vodacom Tanzania. Play games, watch TV, and enjoy unlimited entertainment at affordable prices.",
      ...
      "Choose from our range of high-quality routers and business solutions":
        "Choose from our range of high-quality routers and business solutions",
      "5G Router": "5G Router",
      "High-speed 5G router with wide coverage. Contract-free with 2 months security deposit.":
        "High-speed 5G router with wide coverage. Contract-free with 2 months security deposit.",
      "Starting from 120,000 TZS": "Starting from 120,000 TZS",
      "4G Router": "4G Router",
      "Reliable 4G router for stable connectivity. Contract-free with 2 months security deposit.":
        "Reliable 4G router for stable connectivity. Contract-free with 2 months security deposit.",
      "Starting from 50,000 TZS": "Starting from 50,000 TZS",
      "Master Airtime": "Master Airtime",
      "Perfect solution for small businesses and corporate clients to manage airtime distribution.":
        "Perfect solution for small businesses and corporate clients to manage airtime distribution.",
      "Custom pricing": "Custom pricing",
      "Bulk SMS": "Bulk SMS",
      "Affordable web-based solution to send multiple SMS to multiple recipients at once.":
        "Affordable web-based solution to send multiple SMS to multiple recipients at once.",
      "Pay per use": "Pay per use",

      // Packages Section
      "Unlimited Packages": "Unlimited Packages",
      "Enjoy our unlimited offers with our 5G coverage near your home and office. Play games, watch TV with super speed internet at affordable prices.":
        "Enjoy our unlimited offers with our 5G coverage near your home and office. Play games, watch TV with super speed internet at affordable prices.",
      ...
      "We offer value for your money with competitive pricing":
        "We offer value for your money with competitive pricing",
      "Reliable Service": "Reliable Service",
      "Consistent and dependable internet connection for your needs":
        "Consistent and dependable internet connection for your needs",
      "24/7 Support": "24/7 Support",
      ...
      "Visit us at our office location for in-person assistance":
        "Visit us at our office location for in-person assistance",
      "Vodacom Tanzania - MEMA Holdings": "Vodacom Tanzania - MEMA Holdings",
      "We are located at Dora Tower, Bamaga Sheli, Ground Floor":
        "We are located at Dora Tower, Bamaga Sheli, Ground Floor",
      ...
      "Hello! I'm your Vodacom assistant. How can I help you today?":
        "Hello! I'm your Vodacom assistant. How can I help you today?",
    ...
    sw: {
      ...
      "Experience lightning-fast 5G connectivity with Vodacom Tanzania. Play games, watch TV, and enjoy unlimited entertainment at affordable prices.":
        "Pata mtandao wa kasi wa 5G na Vodacom Tanzania. Cheza michezo, tazama TV, na furahia burudani zisizo na kikomo kwa bei nafuu.",
      ...
      "Experience the future of connectivity with our premium 5G router":
        "Pata mtandao wa kisasa na router yetu bora ya 5G",
      ...
      "Choose from our range of high-quality routers and business solutions":
        "Chagua kutoka kwa router zetu bora na suluhisho za biashara",
      "5G Router": "Router ya 5G",
      "High-speed 5G router with wide coverage. Contract-free with 2 months security deposit.":
        "Router ya kasi ya 5G na mtandao mpana. Hakuna mkataba na amana ya miezi 2.",
      "Starting from 120,000 TZS": "Kuanzia TZS 120,000",
      "4G Router": "Router ya 4G",
      "Reliable 4G router for stable connectivity. Contract-free with 2 months security deposit.":
        "Router ya 4G inayotegemewa kwa mtandao thabiti. Hakuna mkataba na amana ya miezi 2.",
      "Starting from 50,000 TZS": "Kuanzia TZS 50,000",
      "Master Airtime": "Master Airtime",
      "Perfect solution for small businesses and corporate clients to manage airtime distribution.":
        "Suluhisho kamili kwa biashara ndogo na wateja wa kampuni kusimamia usambazaji wa muda wa maongezi.",
      "Custom pricing": "Bei maalum",
      "Bulk SMS": "SMS kwa Wingi",
      "Affordable web-based solution to send multiple SMS to multiple recipients at once.":
        "Suluhisho la bei nafuu la kutuma SMS nyingi kwa wapokeaji wengi kwa wakati mmoja.",
      "Pay per use": "Lipa unapotumia",

      // Packages Section
      "Unlimited Packages": "Vifurushi Visivyo na Kikomo",
      "Enjoy our unlimited offers with our 5G coverage near your home and office. Play games, watch TV with super speed internet at affordable prices.":
        "Furahia ofa zetu zisizo na kikomo na mtandao wetu wa 5G karibu na nyumba na ofisi yako. Cheza michezo, tazama TV kwa intaneti ya kasi kwa bei nafuu.",
      ...
      "We ensure unlimited internet at an affordable price guaranteeing your family entertainment":
        "Tunahakikisha intaneti isiyokoma kwa bei nafuu inayohakikisha burudani kwa familia yako",
      "Super Fast Speed": "Kasi ya Juu Sana",
      "Experience lightning-fast internet speeds with our 5G technology":
        "Pata kasi ya intaneti ya ajabu na teknolojia yetu ya 5G",
      ...
      "Consistent and dependable internet connection for your needs":
        "Muunganisho wa intaneti thabiti na wa kutegemewa kwa mahitaji yako",
      ...
      "Get started today with our high-speed internet packages and transform your online experience.":
        "Anza leo na vifurushi vyetu vya intaneti ya kasi na badilisha uzoefu wako wa mtandaoni.",
      ...
      "Leave your details and we'll get in touch with you as soon as possible.":
        "Acha maelezo yako na tutawasiliana nawe haraka iwezekanavyo.",
      ...
      "Vodacom Tanzania - MEMA Holdings": "Vodacom Tanzania - MEMA Holdings",
      "We are located at Dora Tower, Bamaga Sheli, Ghorofa ya Chini":
        "Tunapatikana katika Dora Tower, Bamaga Sheli, Ghorofa ya Chini",
      ...
      "Hello! I'm your Vodacom assistant. How can I help you today?":
        "Habari! Mimi ni msaidizi wako wa Vodacom. Nawezaje kukusaidia leo?",
  ...
  if (checkoutForm) {
    checkoutForm.addEventListener("submit", (e) => {
      ...
      const subject = encodeURIComponent("New Order from Vodacom Website")
      const body = encodeURIComponent(
        "Please find the attached order details.\n\n" +
      ...
      window.location.href = `mailto:bshipella@gmail.com?subject=${subject}&body=${body}`
  ...
  if (callbackForm) {
    callbackForm.addEventListener("submit", (e) => {
      ...
      csvContent += `${name},${location},${phone},${email},${message}\n`

      // Create mailto link with CSV data
      const subject = encodeURIComponent("Callback Request from Vodacom Website")
      const body = encodeURIComponent(
        "Please find the attached callback request details.\n\n" +
          "Customer Information:\n" +
          `Name: ${name}\n` +
          `Location: ${location}\n` +
          `Phone: ${phone}\n` +
      ...
      showToast(
        "success",
        "Request Submitted",
        "Your callback request has been submitted successfully. We will contact you shortly.",
      )
    })
  }
  ...
  function updateSpeedIndicator() {
    ...
    if (speedPercentage > 60) {
      if (speedValue) speedValue.textContent = "350 Mbps"
      ...
      if (speedValue) speedValue.textContent = "100 Mbps"
      if (downloadTimes && downloadTimes.length >= 2) {
  ...
  const faqData = {
    "package information": [
      "We offer various 4G and 5G packages starting from 50,000 TZS per month.",
      "All our packages come with unlimited data and no contract.",
      "Our most popular package is the 5G Basic at 120,000 TZS per month with speeds up to 30Mbps.",
    ],
    "router setup": [
      "Setting up your router is easy! Just plug it in, wait for the lights to stabilize, and connect to the WiFi network.",
      "The default WiFi name and password are printed on the bottom of your router.",
      "For more detailed instructions, please refer to the manual that came with your router.",
    ],
    "billing questions": [
      "We accept payments via M-Pesa, Tigo Pesa, Airtel Money, and bank transfer.",
      "Payments are due on the 1st of each month.",
      "For any billing issues, please contact our support team at 0753221868.",
    ],
    "technical support": [
      "If you're experiencing connectivity issues, try restarting your router.",
      "Make sure your router is placed in an open area away from walls and metal objects.",
      "For persistent issues, please contact our technical support team at 0753221868.",
    ],
  }
  ...
  function processMessage(message) {
    ...
    if (!responded) {
      setTimeout(() => {
        sendMessage(
          "I'm not sure I understand. Could you try asking about our packages, router setup, billing, or technical support?",
          false,
        )
